...
VERSION_PACKAGE=github.com/dengmengmian/web_complier/pkg/version
...
build: tidy # 编译源码，依赖 tidy 目标自动添加/移除依赖包.
	@go build -v -ldflags "$(GO_LDFLAGS)" -o $(OUTPUT_DIR)/web_complier $(ROOT_DIR)/cmd/web_complier/main.go
